                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{__('dashboard.create')}} {{__('dashboard.request') }} </h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('dashboard.requests.store')}}" method="POST" role="form" >
                            @csrf
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title"
                                           placeholder="{{__('dashboard.title')}}" value="{{ old('title') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="4" cols="50" placeholder="{{__('dashboard.description')}}" required>
                                    </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="request_expiredDate" min="" class="form-control @error('request_expiredDate') is-invalid @enderror" id="request_expiredDate"
                                           placeholder="{{__('dashboard.request_expiredDate')}}" value="{{ old('request_expiredDate') }}" required >
