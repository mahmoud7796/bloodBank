            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ auth()->user()->profile_picture ? asset(viewImage(auth()->user()->profile_picture,'dashboard_files/admins_pictures/')) : asset('dashboard_files/admins_pictures/blank.png') }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('dashboard.admins.edit', auth()->id()) }}" class="btn btn-default btn-flat">{{__('dashboard.profile')}}</a>
                                </div>
